...
# METR-LA
# srun /home/gridsan/shibal/.conda/envs/additive2/bin/python -u main_dyngwn.py --data './data/METR-LA' --adjdata './data/METR-LA/adj_mx.pkl' --n_train 5000 --batch_size 8 --num_nodes 80 --epochs 150 --layers 2 --blocks 4 --gcn_bool --adjtype 'doubletransition' --addaptadj  --randomadj --dynamic_gcn_bool --dynamic_supports_len 1 --dynamic_graph 'partial-correlation' --dynamic_graph_transform 'absolute' --dynamic_graph_window 48 --expid 8 --tuning_seed $SLURM_ARRAY_TASK_ID --workers 8 --learning_rate 0.0001 --save_directory './logs/dyngwn' |& tee -a './logs/dyngwn/METR-LA/Nodes80/Dynamic:True/N5000/Blocks4/partial-correlation/absolute/LR0.0001/8.$SLURM_ARRAY_TASK_ID/tuning.txt'
# srun /home/gridsan/shibal/.conda/envs/additive2/bin/python -u main_dyngwn.py --data './data/METR-LA' --adjdata './data/METR-LA/adj_mx.pkl' --n_train 5000 --batch_size 8 --num_nodes 80 --epochs 150 --layers 2 --blocks 4 --gcn_bool --adjtype 'doubletransition' --addaptadj  --randomadj --dynamic_gcn_bool --dynamic_supports_len 1 --dynamic_graph 'partial-correlation' --dynamic_graph_transform 'absolute' --dynamic_graph_window 48 --expid 8 --tuning_seed $SLURM_ARRAY_TASK_ID --workers 8 --learning_rate 0.0005 --save_directory './logs/dyngwn' |& tee -a './logs/dyngwn/METR-LA/Nodes80/Dynamic:True/N5000/Blocks4/partial-correlation/absolute/LR0.0005/8.$SLURM_ARRAY_TASK_ID/tuning.txt'
# srun /home/gridsan/shibal/.conda/envs/additive2/bin/python -u main_dyngwn.py --data './data/METR-LA' --adjdata './data/METR-LA/adj_mx.pkl' --n_train 5000 --batch_size 8 --num_nodes 80 --epochs 150 --layers 2 --blocks 4 --gcn_bool --adjtype 'doubletransition' --addaptadj  --randomadj --dynamic_gcn_bool --dynamic_supports_len 1 --dynamic_graph 'partial-correlation' --dynamic_graph_transform 'absolute' --dynamic_graph_window 48 --expid 8 --tuning_seed $SLURM_ARRAY_TASK_ID --workers 8 --learning_rate 0.001 --save_directory './logs/dyngwn' |& tee -a './logs/dyngwn/METR-LA/Nodes80/Dynamic:True/N5000/Blocks4/partial-correlation/absolute/LR0.001/8.$SLURM_ARRAY_TASK_ID/tuning.txt'
# srun /home/gridsan/shibal/.conda/envs/additive2/bin/python -u main_dyngwn.py --data './data/METR-LA' --adjdata './data/METR-LA/adj_mx.pkl' --n_train 5000 --batch_size 8 --num_nodes 80 --epochs 150 --layers 2 --blocks 4 --gcn_bool --adjtype 'doubletransition' --addaptadj  --randomadj --dynamic_gcn_bool --dynamic_supports_len 1 --dynamic_graph 'partial-correlation' --dynamic_graph_transform 'absolute' --dynamic_graph_window 48 --expid 8 --tuning_seed $SLURM_ARRAY_TASK_ID --workers 8 --learning_rate 0.005 --save_directory './logs/dyngwn' |& tee -a './logs/dyngwn/METR-LA/Nodes80/Dynamic:True/N5000/Blocks4/partial-correlation/absolute/LR0.005/8.$SLURM_ARRAY_TASK_ID/tuning.txt'
# srun /home/gridsan/shibal/.conda/envs/additive2/bin/python -u main_dyngwn.py --data './data/METR-LA' --adjdata './data/METR-LA/adj_mx.pkl' --n_train 5000 --batch_size 8 --num_nodes 80 --epochs 150 --layers 2 --blocks 4 --gcn_bool --adjtype 'doubletransition' --addaptadj  --randomadj --dynamic_gcn_bool --dynamic_supports_len 1 --dynamic_graph 'partial-correlation' --dynamic_graph_transform 'absolute' --dynamic_graph_window 48 --expid 8 --tuning_seed $SLURM_ARRAY_TASK_ID --workers 8 --learning_rate 0.01 --save_directory './logs/dyngwn' |& tee -a './logs/dyngwn/METR-LA/Nodes80/Dynamic:True/N5000/Blocks4/partial-correlation/absolute/LR0.01/8.$SLURM_ARRAY_TASK_ID/tuning.txt'
